        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            {isDemoMode
              ...
              : 'Generated by Gemini AI from your real family and nutrition data.'}
          </p>
        </div>
        <button
        ...
        <div className="relative">
          ...
          {isGenerating ? (
            <div className="flex items-center gap-3">
              ...
              <span>Gemini AI is analyzing your family's nutrition data…</span>
            </div>
          ) : topInsight ? (
            <>
            ...
            {!isDemoMode && (
              <>
                <p className="text-sm mb-4">
                  Click "Generate Insights" to get personalized recommendations from Gemini AI.
                </p>
                <button
                  onClick={generateInsights}
